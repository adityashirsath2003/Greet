...
class Program
{
    ...
    // }
        ...
        List<Enrollment> e= new List<Enrollment>
        {
            ...
            new Enrollment { EnrollmentId = 104, StudentId = 4, Course = "Geography" },
        ...
        foreach (var g1 in x){
            x1 = g1.Name;
            if(g1.g.Count() == 0){
               Console.WriteLine("Name : {x1} and Course: Null");
            }
        foreach (var item in g1.g)
        {
            Console.WriteLine($"Name : {x1} and Course: {item.EnrollmentId}");
        }
